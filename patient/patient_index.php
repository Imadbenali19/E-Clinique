<?php
session_start();
$_SESSION['username']=$_SESSION['nomC'];
...
<body>
    <div class="container" >
        ...
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="patient_index.php" id="mrdv" >Mes rendez-vous</a>
            </li>
            <li class="nav-item">
    ...
    <table class="table">
			...
			<tbody>
				<?php
                    ...
                    $req="select m.idM idMed,m.nom Mnom,m.prenom Mpren,r.* from rendezvous r,medecin m where r.idM=m.idM and r.idP='$idPatient'";
					...
					while($row=mysqli_fetch_array($query)){
						...
						<tr>
                            ...
                            <?php 
                                ...
                                if($row['statut']=='actif'){
                                    $numM=$row['idMed'];
                                    $direction='cancelAppointement.php?'."idRdv=$d&numM=$numM";
                                    $ch='Annuler';
                                }else{
