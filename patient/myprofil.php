...
<body>
    ...
    <thead class="table-light">
			...
			<tbody>
				<?php
                    $myId=$_SESSION['idPatient'];
                    $query=mysqli_query($conn,"select * from patient where idP='$myId'");
					while($row=mysqli_fetch_array($query)){
						...
						<tr>
                            ...
                            <td>
                                <a href="editMyProfil.php?idPatient=<?php echo $row['idP']; ?>">Modifier</a> |
								<a href="deleteMe.php?idPatient=<?php echo $row['idP']; ?>&nomPatient=<?php echo $row['nom']; ?>&prenomPatient=<?php echo $row['prenom']; ?>">Demande de suppression</a>
							</td>
						</tr>
						<?php
					}
