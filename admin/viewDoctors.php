...
<body>
    <div class="container" >
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="viewDoctors.php" id="lm">Lister medecins</a>
            </li>
...
<div>
        <a href="addDoctor.php"  style="margin: 15px;">Voulez vous ajouter un medecin?</a> <br>
		<table class="table" style="margin-top: 15px;">
			...
			<tbody>
				<?php
					$query=mysqli_query($conn,"select * from medecin");
					while($row=mysqli_fetch_array($query)){
						?>
						<tr id="<?php echo $row['idM']; ?>">
                            ...
                            <td>
								<a href="addDoctor.php?idDoctor=<?php echo $row['idM']; ?>">Modifier</a>
								<a href="deleteDoctor.php?idDoctor=<?php echo $row['idM']; ?>&nomDoctor=<?php echo $row['nom']; ?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer ce medecin?'));">Supprimer</a>
							</td>
						</tr>
						<?php
					}
...
<script>
    var x=document.getElementById("dash");
        ...
        document.getElementById("<?php if(isset($_GET['idMe'])) echo $_GET['idMe']; ?>").style.backgroundColor="cyan";
